...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.MajorID = field.NewInt64(tableName, "major_id")
	_message.ReceiveStudentID = field.NewInt64(tableName, "receive_student_id")
	_message.ReceiveTeacherID = field.NewInt64(tableName, "receive_teacher_id")
	_message.CreatedAt = field.NewTime(tableName, "created_at")
	_message.State = field.NewInt8(tableName, "state")
	_message.IsDelete = field.NewField(tableName, "is_delete")
...
type message struct {
	...
	SendID           field.Int64  // 发件人
	MajorID          field.Int64  // 专业id
	ReceiveStudentID field.Int64  // 接收学生
	ReceiveTeacherID field.Int64  // 接收老师
	CreatedAt        field.Time   // 发布时间
	State            field.Int8   // 消息状态
...
func (m *message) updateTableName(table string) *message {
	...
	m.MajorID = field.NewInt64(table, "major_id")
	m.ReceiveStudentID = field.NewInt64(table, "receive_student_id")
	m.ReceiveTeacherID = field.NewInt64(table, "receive_teacher_id")
	m.CreatedAt = field.NewTime(table, "created_at")
	m.State = field.NewInt8(table, "state")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["receive_student_id"] = m.ReceiveStudentID
	m.fieldMap["receive_teacher_id"] = m.ReceiveTeacherID
