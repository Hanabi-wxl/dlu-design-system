...
func newStudent(db *gorm.DB, opts ...gen.DOOption) student {
	...
	_student.Number = field.NewString(tableName, "number")
	_student.Name = field.NewString(tableName, "name")
	_student.Password = field.NewString(tableName, "password")
	_student.Grade = field.NewInt64(tableName, "grade")
	_student.Phone = field.NewString(tableName, "phone")
	_student.Email = field.NewString(tableName, "email")
	_student.Gender = field.NewInt8(tableName, "gender")
	_student.SubjectID = field.NewInt64(tableName, "subject_id")
	_student.CollegeID = field.NewInt64(tableName, "college_id")
	_student.MajorID = field.NewInt64(tableName, "major_id")
	_student.ClassID = field.NewInt64(tableName, "class_id")
	_student.IsDelete = field.NewField(tableName, "is_delete")
...
func (s *student) updateTableName(table string) *student {
	...
	s.Gender = field.NewInt8(table, "gender")
	...
	s.ClassID = field.NewInt64(table, "class_id")
