...
func newPlan(db *gorm.DB, opts ...gen.DOOption) plan {
	...
	_plan.Content = field.NewString(tableName, "content")
	_plan.Week = field.NewInt8(tableName, "week")
	_plan.SubjectID = field.NewInt64(tableName, "subject_id")
	_plan.IsDelete = field.NewField(tableName, "is_delete")
...
type plan struct {
	...
	ALL       field.Asterisk
	ID        field.Int64  // id
	Content   field.String // 计划内容
	Week      field.Int8   // 计划时间（周）
...
func (p *plan) updateTableName(table string) *plan {
	...
	p.Week = field.NewInt8(table, "week")
	p.SubjectID = field.NewInt64(table, "subject_id")
	p.IsDelete = field.NewField(table, "is_delete")
