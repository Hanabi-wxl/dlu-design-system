...
const TableNameSubjectType = "subject_type"

// SubjectType mapped from table <subject_type>
...
// TableName SubjectType's table name
func (*SubjectType) TableName() string {
	return TableNameSubjectType
}
